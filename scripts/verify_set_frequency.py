...
value. It writes a CSV recording the requested vs actual frequency and
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=float,
        default=50.0,
        help="Step size between frequency points in Hz (default: 50)",
    )
    parser.add_argument(
        "--phase-seconds",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Command velocity used during frequency testing in ERPM (default: 1000)",
    )
    parser.add_argument(
        "--plot-path",
        default=None,
